...
begin
  ...
  for i:=0 to (nMainRegs-1) do begin
    ...
    //Sprawdzam ile kluczy GSTARCADa jest poprawnych (czyli takich w postaci pl-Pl które zawieraj¹ watoœæ Location)
    nNewRegsCorrect:=0;
...
begin
  ...
  DefaultProfil.Caption := 'Domyœlnym profilem:' #13 '  -dla GSTARCAD-a jest <<Nienazwany profil>>' #13;
