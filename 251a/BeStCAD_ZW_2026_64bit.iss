...
[Setup]
AppName=BeStCAD ZW 2026
AppVerName=BeStCAD ZW 2026 64bit
...
DefaultDirName={pf}\BeStCAD ZW 2026
DefaultGroupName=BeStCAD ZW 2026
DisableProgramGroupPage=yes
AllowNoIcons=false
LicenseFile=d:\3_Instalki\BestInstSetup\$BestLinki\251a\OutPutZW\Licencja.txt
InfoBeforeFile=d:\3_Instalki\BestInstSetup\$BestLinki\251a\OutPutZW\Readme_64bit.txt
InfoAfterFile=d:\3_Instalki\BestInstSetup\$BestLinki\251a\OutPutZW\Zmiany.txt
OutputDir=d:\3_Instalki\BestInstSetup\$BestLinki\251a\OutPutZW
SourceDir=d:\3_Instalki\BestInstSetup\$BestLinki\251a 
OutputBaseFilename=BeStCAD2026ZW_64bit
AlwaysRestart=false
PrivilegesRequired=admin
MinVersion=6.1
DisableStartupPrompt=no
RestartIfNeededByRun=true
UninstallDisplayIcon={app}\Best2026ZW.ico
UninstallFilesDir={app}
DirExistsWarning=no
VersionInfoVersion=251
VersionInfoCompany=CADmost
VersionInfoDescription=BeStCAD ZW 2026 dla ZWCAD 2021, 2022, 2023, 2024, 2025, 2026 64bit
...
;; links from BeStCAD\Dodatki
Source: BeStCAD\Dodatki\VC_redist.x64.exe; DestDir: {app}; Flags: deleteafterinstall
;;-----------------------------------------------------------
;; links for ZWCAD only
;;-----------------------------------------------------------
;; links from Zrx i Fas
Source: FullZW\Exe\x64A\*.*; DestDir: {app}; Check: IsZWArch
Source: FullZW\Exe\x64\*.*; DestDir: {app}; Check: IsZW
Source: FullZW\*.*; DestDir: {app}
Source: FullZW\Zrx\x64\*.*; DestDir: {app}\Arx
Source: FullZW\Fas\*.*; DestDir: {app}\Fas
Source: FullZW\Fas\ZELX1\*.*; DestDir: {app}\Fas; Check: IsZWArch
Source: FullZW\Fas\ZELX2\*.*; DestDir: {app}\Fas; Check: IsZW
;;Source: FullZW\Fas\par\*.*; DestDir: {app}\Fas\Par
Source: FullZW\Fas\ZELX1\par\*.*; DestDir: {app}\Fas\Par; Check: IsZWArch
Source: FullZW\Fas\ZELX2\par\*.*; DestDir: {app}\Fas\Par; Check: IsZW
Source: FullZW\Fas\odsR17\*.*; DestDir: {app}\Fas
Source: FullZW\Fas\ModelTerenu\*.*; DestDir: {app}\Fas\ModelTerenu
Source: FullZW\Fas\Niweleta\*.*; DestDir: {app}\Fas\Niweleta
;; links from OutPutZW
Source: OutPutZW\Licencja.txt; DestDir: {app}\Text
Source: OutPutZW\Zmiany.txt; DestDir: {app}\Text
Source: OutPutZW\Win7_Win8_Win10_Win11!.txt; DestDir: {app}\Text
Source: OutPutZW\Instalacja-Rejestracja BeStCAD.pdf; DestDir: {app}\Pomoc
Source: OutPutZW\Readme_64bit.txt; DestDir: {app}\Text
Source: OutPutZW\BeStCAD.ver; DestDir: {app}\Text
Source: OutPutZW\Dane.ser; DestDir: {app}\Text
Source: OutPutZW\Dane.ser; DestDir: {app}
;-----------------------------------------------------------
;; other links
;-----------------------------------------------------------
;; biblioteki from $Dll
...
[Icons]
Name: {group}\BeStCAD ZW 2026; Filename: {app}\BeStCADZW.exe; Parameters: /p BestZW251 /t 2026Best.dwt /nologo; WorkingDir: {userdocs}; IconFilename: {app}\Best2026ZW.ico; Comment: Uruchom BeStCAD ZW 2026
Name: {commondesktop}\BeStCAD ZW 2026; Filename: {app}\BeStCADZW.exe; Parameters: /p BestZW251 /t 2026Best.dwt /nologo; WorkingDir: {userdocs}; IconFilename: {app}\Best2026ZW.ico; Comment: Uruchom BeStCAD ZW 2026
Name: {group}\Uninstall BeStCAD ZW 2026; Filename: {uninstallexe}; IconFilename: {app}\Best2026ZW.ico; IconIndex: 0; Comment: Odinstaluj BeStCAD ZW 2026

[_ISTool]
EnableISX=false
UseAbsolutePaths=false
OutputExeFilename=d:\3_Instalki\BestInstSetup\$BestLinki\251a\OutPutZW\BeStCAD_ZW_2026_64bit.exe
...
[Languages]
Name: default; MessagesFile: compiler:Polish.isl; LicenseFile: OutPutZW\Licencja.txt; InfoBeforeFile: OutPutZW\Readme_64bit.txt; InfoAfterFile: OutPutZW\Zmiany.txt
...
Filename: {app}\vc_redist.x64.exe; Parameters: "/quiet /norestart";Check: NeedsVC2015Runtime

[Code]

const
  regAutoCAD1 = 'SOFTWARE\ZWSOFT\ZWCAD\';
  regAutoCAD2 = 'SOFTWARE\ZWSOFT\ZWCADA\';
  //regAutoCAD = 'SOFTWARE\ZWSOFT\ZWCAD\';
  COMPANY_NAME = 'Ams';
  //plikWymianyRej = 'c:\BeStCADPlikWymianyRej.txt';

//**************************************************************
//********** to trzeba zmieniæ przy zmianie wersji  ************
  BeStCADProfVer = 'BestZW251';
//**************************************************************
...
var
  ...
  build: Cardinal;
begin
  // Sprawdzenie czy zainstalowany jest klucz redist
...
begin
  ...
  //HKEY_LOCAL_MACHINE\SOFTWARE\AMS\BeStCAD181   BeStCADLocation='C:\Program Files\BeStCAD 2026'
  sKey := 'SOFTWARE\' + COMPANY_NAME + '\' + BeStCADProfVer;
  RegWriteStringValue ( HKEY_LOCAL_MACHINE, sKey, 'BeStCADLocation', sPathToBeStCAD );
  //zapisanie w rejestrach na jakiej wersji zwcada zainstalowany jest BeStCAD
  ...
  //sAcadVer := '';
  //for i:=1 to 4 do 
  //  sAcadRel := sAcadRel + StrGet(sAcadRelVer, i);
  //for i:=6 to Length(sAcadRelVer) do 
  //  sAcadVer := sAcadVer + StrGet(sAcadRelVer, i);
    
    
  sAcadRel := Copy(sAcadRelVer, 1, 4);  // Copy zaczyna od 1
  sAcadVer := Copy(sAcadRelVer, 6, Length(sAcadRelVer));
  ...
  regAcadProfiles := regAcadProfiles + '\' + sAktualProfil + '\Config';
  if ( not RegQueryStringValue ( HKEY_CURRENT_USER, regAcadProfiles, 'ZWCADSEARCHPATH', sZmiennaACAD ) ) then begin
    MsgBox( sMsg3 + ' / ' + sZmiennaACAD + ' / ' + regAcadProfiles, mbError, MB_OK );
    SendMessage(hWnd, $010, $00000000 , $00000000);
  end else begin
    //odczytanie sciezki do template z aktualnego profilu
    RegQueryStringValue ( HKEY_CURRENT_USER, regAcadProfiles, 'Template', sTemplatePath);
    ...
    regAcadProfiles := regAcadRelVer + '\Profiles' + '\' + BeStCADProfVer + '\Config';
    //
    ...
    SaveStringToFile(plikWymianyRej, '@' + 'ZWCADSEARCHPATH', True);
...
begin
  ...
  RegQueryStringValue ( HKEY_CURRENT_USER, regAcadProfiles, 'ZWCADTEMPLATEPATH', sTemplatePath );
...
begin
  ...
  if ( ( Pos('BESTZW', NazwaProfilu) > 0 ) and (IntNumerWersji <> 0) )then
  begin
    wynik := False;
  end;
  Result := wynik;
...
begin
  ...
  begin
    if (Length(AllProfilesAcad[iii]) = 9) then
    begin
...
begin
  ...
  RegGetSubkeyNames(HKEY_LOCAL_MACHINE, regAutoCAD1, tabAcadMainRegs1);//dla zwyklego zwcad
  RegGetSubkeyNames(HKEY_LOCAL_MACHINE, regAutoCAD2, tabAcadMainRegs2);//dla architecturala
  
  //wyrzucenie z tablicy ZWcadów innych niz 2026
  stringWersja := '2026';
  ListStringWersja := ['2026', '2025', '2024', '2023', '2022', '2021'];
  ...
  for i:=0 to (nMainRegs2-1) do begin
    if (IsStringInList(tabAcadMainRegs2[i], ListStringWersja))then begin
      j:=j+1;
      SetArrayLength(tabAcadNewMainRegs, j);
      tabAcadNewMainRegs[j-1]:='A' + tabAcadMainRegs2[i];
    end;
  ...
  for i:=0 to (nMainRegs-1) do begin
    //w zale¿nosci czy jest to zwyk³y ZWCAD czy Architectural
    //if (tabAcadNewMainRegs[i] = stringWersja)then begin
    //  regAutoCADTym:=regAutoCAD1;
    ...
    //Sprawdzam ile kluczy ZWcada jest poprawnych (czyli takich w postaci pl-Pl które zawieraj¹ watoœæ Location)
    nNewRegsCorrect:=0;
    for j:=0 to (nNewRegs-1) do begin
      ...
      if RegValueExists(HKEY_LOCAL_MACHINE, regAutoCADTym + tabAcadNewMainRegs[i] + '\' + tabNewRegs[j], 'Location') and
    ...
    for j:=0 to (nNewRegs-1) do begin
      ...
      if RegValueExists(HKEY_LOCAL_MACHINE, strSubKeysAcad + '\' + tabNewRegs[j], 'Location') and
        SubKeyExists(HKEY_CURRENT_USER, strSubKeysAcad, tabNewRegs[j]) and
        CheckAcadProfiles(strSubKeysAcad+ '\' + tabNewRegs[j] + '\Profiles', 'Brak profili w rejestrze', hWnd) then
      begin
        if RegQueryStringValue (HKEY_LOCAL_MACHINE, strSubKeysAcad + '\' + tabNewRegs[j], 'Location', sLocation) then
          begin
...
begin
  ...
  //tworzymy nowa liste profili pomijajacych profile 9 znakowe zaczynajace sie na BESTCAD
...
begin
  ...
  DefaultProfil.Caption := 'Domyœlnym profilem:' #13 '  -dla ZWCAD-a jest Default' #13;
...
begin
  ...
  Uwaggga.Caption := 
    'Lista zawiera tylko zainstalowane aplikacje ZWCAD, uruchomione przynajmniej' + #13#10 +  
    ...
    case nAcadRegs of
      0:
        begin
          ...
          MsgBox('Instalator nie wykry³ w rejestrach tego komputera' #13 '64-bitowej wersji ZWCADa' #13 'Przerwano dalsz¹ instalacjê.', mbError, MB_OK );
          SendMessage(hWnd, $010, $00000000 , $00000000);
        end;
      1:
        begin
          ...
          if TylkoJedenRaz then begin
            ...
            PageSelectProf := CreateCustomPage(wpInfoBefore, 'Wybór profilu ZWCADa','Zainstalowany ZWCAD posiada nastepujace profile' #13 'Wybierz jeden na którym bêdzie zainstalowany BeStCAD:');
            TylkoJedenRaz := False;
          end;
          tabProfilesAcad := GetRegProfilesAcad(sSelectedAcad);
          OknoProfiluAcada();
        ...
        begin
          //jesli jest wiecej ZWCADOW to trzeba wywolac okno z wyborem wersji
          sSelectedAcad:=tabAcadRegs[0];
          ...
          if TylkoJedenRaz then begin
            ...
            PageSelectAcad := CreateCustomPage(wpInfoBefore, 'Wybór wersji ZWCADa', 'Na Twoim komputerze zainstalowane s¹ poni¿sze wersje ZWCADa.' #13 'Wybierz jedn¹ z nich.');
            //Nowe okno wyboru profilu na ktorym autocad zostanie zainstalowany
            PageSelectProf := CreateCustomPage(PageSelectAcad.ID, 'Wybór profilu ZWCADa','Wybrany ZWCAD posiada nastêpuj¹ce profile' #13 'Wybierz jeden na którym bêdzie zainstalowany BeStCAD:');
            TylkoJedenRaz := False;
          end;
...
begin
  ...
  if  nAcadRegs=0 then begin
     ...
     MsgBox('Instalator nie wykry³ w rejestrach tego komputera' #13 '64-bitowej wersji ZWCADa 2021, 2022, 2023, 2024, 2025, 2026' #13 'Przerwano dalsz¹ instalacjê.', mbError, MB_OK );
     //SendMessage(hWnd, $010, $00000000 , $00000000);
     Result := false;
  end else begin
     Result := true;
